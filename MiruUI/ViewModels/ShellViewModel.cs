...
namespace Miru.ViewModels
{
    public class ShellViewModel : Screen
    {
        ...
        private UserAnimeList CurrentUserAnimeList { get; set; }

        public Season CurrentSeason { get; set; }

        // stores last sync date
        private DateTime SyncDate { get; set; }
        ...
        public async Task SyncUserAnimeList(string typedInUsername, MiruAppStatus appStatus, bool syncSeasonList)
        {
            ...
            using (var db = new MiruDbContext())
            {
                ...
                await GetAiringAnimeBroadcastTimes(db, CurrentUserAnimeList.Anime, syncSeasonList);
            }
        ...
        /// <returns></returns>
        public async Task GetAiringAnimeBroadcastTimes(MiruDbContext db, ICollection<AnimeListEntry> animeListEntries, bool syncSeasonList)
        {
